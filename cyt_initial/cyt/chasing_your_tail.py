...
cyt_sub = pathlib.Path('/home/pi/Desktop/chasing_your_tail/cyt_initial/cyt/cyt_sub')
...
log_file_name = '/home/pi/Desktop/chasing_your_tail/cyt_initial/cyt/cyt_sub/cyt_log_' + time.strftime('%m%d%y_%H%M%S')
